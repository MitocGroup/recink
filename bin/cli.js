...
const commands = prog
  ...
  .option('--tf-vars', 'Extend terraform variables', prog.LIST, [])
  .option('--tf-workspace', 'Terraform workspace', /.*/, undefined)
  .option('--tf-varfiles', 'Terraform variables', prog.LIST, [])
  .option('--tf-version', 'Terraform version',  /.*/, undefined)
